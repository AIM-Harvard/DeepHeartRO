"""
  ----------------------------------------
    HeartLoc - run Deep Heart Segmentation pipeline step1
  ----------------------------------------
  ----------------------------------------
  Author: AIM Harvard
...
# create the sub-folders where the results are going to be stored
if not os.path.exists(curated_dir_path):
  os.makedirs(curated_dir_path)
if not os.path.exists(qc_curated_dir_path):
  os.mkdir(qc_curated_dir_path)
if not os.path.exists(resampled_dir_path):
  os.mkdir(resampled_dir_path)
if not os.path.exists(model_input_dir_path):
  os.mkdir(model_input_dir_path)
...
if not os.path.exists(model_output_nrrd_dir_path):
  os.mkdir(model_output_nrrd_dir_path)
