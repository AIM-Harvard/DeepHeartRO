...
def run_inference(model_weights_dir_path, data_dir, output_dir, weights_file_name, export_png,
                  final_size, training_size, down_steps, extended, mgpu):

  print '\nDeep Learning model inference using', mgpu, 'GPUs'
  ...
  model = heartseg_model.getUnet3d(down_steps=down_steps, input_shape=inputShape, mgpu=mgpu, ext=extended)
